      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-extension" data-toggle="tab"><?php echo $tab_extension; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-extension">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-versions"><?php echo $entry_extension_versions; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_versions" value="<?php echo $config_extension_versions; ?>" placeholder="<?php echo $entry_extension_versions; ?>" id="input-extension-versions" class="form-control" />
                  <?php if (isset($error_extension_versions)) { ?>
                  <div class="text-danger"><?php echo $error_extension_versions; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-license-types"><?php echo $entry_extension_license_types; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_license_types" value="<?php echo $config_extension_license_types; ?>" placeholder="<?php echo $entry_extension_license_types; ?>" id="input-extension-license-types" class="form-control" />
                  <?php if (isset($error_extension_license_types)) { ?>
                  <div class="text-danger"><?php echo $error_extension_license_types; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-license-periods"><?php echo $entry_extension_license_periods; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_license_periods" value="<?php echo $config_extension_license_periods; ?>" placeholder="<?php echo $entry_extension_license_periods; ?>" id="input-extension-license-periods" class="form-control" />
                  <?php if (isset($error_extension_license_periods)) { ?>
                  <div class="text-danger"><?php echo $error_extension_license_periods; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-name"><?php echo $entry_extension_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_name" value="<?php echo $config_extension_name; ?>" placeholder="<?php echo $entry_extension_name; ?>" id="input-extension-name" class="form-control" />
                  <?php if (isset($error_extension_name)) { ?>
                  <div class="text-danger"><?php echo $error_extension_name; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-price"><?php echo $entry_extension_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_price" value="<?php echo $config_extension_price; ?>" placeholder="<?php echo $entry_extension_price; ?>" id="input-extension-price" class="form-control" />
                  <?php if (isset($error_extension_price)) { ?>
                  <div class="text-danger"><?php echo $error_extension_price; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-description"><?php echo $entry_extension_description; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_description" value="<?php echo $config_extension_description; ?>" placeholder="<?php echo $entry_extension_description; ?>" id="input-extension-description" class="form-control" />
                  <?php if (isset($error_extension_description)) { ?>
                  <div class="text-danger"><?php echo $error_extension_description; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-documentation"><?php echo $entry_extension_documentation; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_documentation" value="<?php echo $config_extension_documentation; ?>" placeholder="<?php echo $entry_extension_documentation; ?>" id="input-extension-documentation" class="form-control" />
                  <?php if (isset($error_extension_documentation)) { ?>
                  <div class="text-danger"><?php echo $error_extension_documentation; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-changelog"><?php echo $entry_extension_changelog; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_changelog" value="<?php echo $config_extension_changelog; ?>" placeholder="<?php echo $entry_extension_changelog; ?>" id="input-extension-changelog" class="form-control" />
                  <?php if (isset($error_extension_changelog)) { ?>
                  <div class="text-danger"><?php echo $error_extension_changelog; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-tag-count"><?php echo $entry_extension_tag_count; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_tag_count" value="<?php echo $config_extension_tag_count; ?>" placeholder="<?php echo $entry_extension_tag_count; ?>" id="input-extension-tag-count" class="form-control" />
                  <?php if (isset($error_extension_tag_count)) { ?>
                  <div class="text-danger"><?php echo $error_extension_tag_count; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-extension-tag-char"><?php echo $entry_extension_tag_char; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_extension_tag_char" value="<?php echo $config_extension_tag_char; ?>" placeholder="<?php echo $entry_extension_tag_char; ?>" id="input-extension-tag-char" class="form-control" />
                  <?php if (isset($error_extension_tag_char)) { ?>
                  <div class="text-danger"><?php echo $error_extension_tag_char; ?></div>
                  <?php } ?>
                </div>
              </div>
            </div>
              ...
              <fieldset>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php if (isset($error_limit_admin)) { ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php } ?>
                    <?php if (isset($error_customer_group_display)) { ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php if (isset($error_login_attempts)) { ?>
            ...
            <div class="tab-pane" id="tab-ftp">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if (isset($error_ftp_hostname)) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if (isset($error_ftp_username)) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if (isset($error_ftp_password)) { ?>
              ...
              <fieldset>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php if (isset($error_error_filename)) { ?>
